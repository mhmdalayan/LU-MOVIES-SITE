...
function updateCarousel() {
    carousel.style.transition =carousel.style.transition = 'transform 0.6s ease-in-out';
    carousel.style.transform = `translateX(-${currentIndex * 100}%)`;
}
...
function nextSlide() {
    ...
    // Reset to the first real slide when reaching the cloned first slide
...
function prevSlide() {
    ...
    // Reset to the last real slide when reaching the cloned last slide
    if (currentIndex === 0) {
        setTimeout(() => {
            carousel.style.transition = 'none';
...
function initializeCarousel(carouselSelector, slideSelector, prevButtonSelector, nextButtonSelector) {
    ...
    carousel.style.width = `${300 * totalSlides}px`;
    ...
    function updateCarousel() {
        ...
        // Calculate the correct position of the carousel based on currentIndex
    ...
    function nextSlide() {
        // Loop to the first slide when the end is reached
    ...
    function prevSlide() {
        // Loop to the last slide when the beginning is reached
...
function scrollToTop() {
  ...
  function suggetion(){
 input = document.getElementsByClassName("searchTab");
...
// Sample Movie Data
const movieData = {
    title: "Bogotá: City ofnkhk the Lost",
    image: "",
    description: "After moving to Bogotá for a chance at a better life, a young Korean man rises through the Colombian black market — risking peril for a shot at success.",
    score: 62,
...
const sololeveling ={
    ...
    genres: ["Thriller", "Comedy", "Action"],
    duration: 102,
    trailer: "https://www.youtube.com/embed/I6JIwjWOhnQ?si=uzuCbP652Z-9NEKG",
    cast: [
        { name: "Actor 1", image: "logo/actors/actor.3.jpg" },
        { name: "Actor 2", image: "logo/actors/actor.jpg" },
        { name: "Actor 3", image: "logo/actors/actor2.jpg" }
...
const johnwick ={
    title: "John wick",
    image: "logo/Movies/download.jpg",
    description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium harum blanditiis delectus. Voluptatem, incidunt ducimus quas rem amet at voluptas veniam nobis numquam pariatur? Provident, dolor a! Earum, fuga quisquam.",
    score: 81,
    releaseDate: "2008-01-05",
    genres: ["Thriller", "Comedy", "Action"],
    duration: 102,
    trailer: "https://www.youtube.com/embed/XGk2EfbD_Ps?si=6PAtzmTS1lpxOasf",
    cast: [
        { name: "Actor 1", image: "logo/actors/actor.3.jpg" },
        { name: "Actor 2", image: "logo/actors/actor.jpg" },
        { name: "Actor 3", image: "logo/actors/actor2.jpg" }
